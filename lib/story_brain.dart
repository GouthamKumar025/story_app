...
class StoryBrain {
  ...
  void nextStory(int choice_number) {
    if (_story_number == 0 && choice_number == 1) {
      _story_number = 2;
    } else if (_story_number == 0 && choice_number == 2) {
      _story_number = 1;
    } else if (_story_number == 2 && choice_number == 1) {
      _story_number = 5;
    } else if (_story_number == 2 && choice_number == 2) {
      _story_number = 4;
    } else if (_story_number == 1 && choice_number == 1) {
      _story_number = 2;
    } else if (_story_number == 1 && choice_number == 2) {
      _story_number = 3;
    } else if (_story_number == 3 || _story_number == 4 || _story_number == 5) {
      restart();
    }
  }
  ...
  bool buttonShouldBeVisible() {
    if (_story_number == 0 || _story_number == 1 || _story_number == 2) {
      return true;
    } else {
      return false;
    }
